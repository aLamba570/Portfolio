...
const Data = () => {
    return(
        <div className="home_data">
            <h1 className="home_title">Ankush Lamba
            ...
            <p className="home_description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet eligendi, aliquid cupiditate velit amet ipsam reiciendis dolore facilis, nemo unde veritatis nam dolores in at facere ipsum, perspiciatis nisi libero!</p>
